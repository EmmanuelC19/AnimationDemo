...
/*: 
 ...
 There are different kinds of options available to try on your animations. You can, of course, read the documentation by option+click-ing `UIViewAnimationOptions` below. But, if you wonder what they actually *look like*, here are some experiments to try :
...
let beachballOptions: UIViewAnimationOptions = [.curveEaseIn, .autoreverse]

let drinkOptions: UIViewAnimationOptions = [.curveEaseOut, .autoreverse]

let icecreamOptions: UIViewAnimationOptions = [.curveLinear, .autoreverse]
